...
toks = [VOID, BOOL, CHAR, BYTE, U8, I8, F8, U16, I16, F16, GLYPH, U32, I32,
        ...
        MAIN, PRINT, PRINTLN, LEFT_BRACKET, RIGHT_BRACKET, LEFT_PARENTHESIS,
        RIGHT_PARENTHESIS, LEFT_CURLY_BRACE, RIGHT_CURLY_BRACE, FOR, WHILE,
        DO, IF, ELSE, IN, SWITCH, DEFAULT, BREAK, CONTINUE, CASE, MATCH,
        IMPORT, MUT, RETURN]
